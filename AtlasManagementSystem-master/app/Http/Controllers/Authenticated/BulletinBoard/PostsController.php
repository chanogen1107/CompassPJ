...
class PostsController extends Controller
{
    public function show(Request $request){
        $postlike=new Post;
        // dd($postlike->likes());
        $posts = Post::with('user','postComments','likes','SubCategory')->get();
        // dd($posts);
        ...
        if(!empty($request->keyword)){
            ...
            // ->where('sub_category_id', $sub_category)->get();
    ...
    public function postCreate(PostFormRequest $request){
        // dd(Post::with('SubCategory')->get());
        // dd($request);
        $Postsub=$request->post_category_id;
        $post = Post::create([
            'user_id' => Auth::id(),
    ...
    public function subCategoryCreate(SubCategoryRequest $request){
        ...
        SubCategory::create([
            ...
            'main_category_id'=> $request->main_category_id//メインカテゴリーのidの取り方。
    ]);
        return redirect()->route('post.input');
    }
